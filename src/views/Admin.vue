<template>
    <div class="table-page loading-page" id="TablePage" dark-class="table-page-dark">
            ...
            <div class="base-box" id="BaseID">
                ...
                <div class="operating-box" :class="{ 'operating-suspension': suspension }">
                    ...
                    <div class="operating-item" v-for="(item, idx) in table" :key="idx">
                        ...
                        <div class="button-box" v-if="item.grade !== '超级用户'">
                            <button :style="{ background: '#2faaf7', color: '#ffffff' }" @click="$refs.comp_authorization.display(item.uuid)">
                                权限管理
                            </button>
                        </div>
                    </div>
        ...
        <comp-authorization ref="comp_authorization"></comp-authorization>
    </div>
</template>
...
import CompAuthorization from "@/components/comp-authorization.vue"
